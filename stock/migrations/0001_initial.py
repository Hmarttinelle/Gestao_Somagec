    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule', models.CharField(choices=[('MANUAL', 'Manual (apenas através do botão no admin)'), ('DIARIO', 'Diário'), ('SEMANAL', 'Semanal')], default='MANUAL', help_text='Define a frequência com que os backups automáticos devem ser executados.', max_length=10, verbose_name='Frequência do Backup Automático')),
                ('recipient_email', models.EmailField(help_text='O endereço de email para onde os ficheiros de backup serão enviados.', max_length=254, verbose_name='Email de Destino para Backups')),
                ('last_backup_status', models.CharField(default='Nunca executado', editable=False, max_length=255, verbose_name='Estado do Último Backup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='clientes_modificados', to=settings.AUTH_USER_MODEL)),
                ('utilizador', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='clientes_criados', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='faturas_modificadas', to=settings.AUTH_USER_MODEL, verbose_name='Modificado por')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_em', models.DateTimeField(auto_now_add=True)),
                ('atualizado_em', models.DateTimeField(auto_now=True)),
                ('fatura', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='guia_transporte', to='stock.fatura', verbose_name='fatura de origem')),
                ('utilizador', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Criado por')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilizador', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='produtos_criados', to=settings.AUTH_USER_MODEL)),
            ],
            options={
