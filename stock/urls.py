...
urlpatterns = [
    ...
    path('faturas/<int:fatura_id>/criar_guia/', views.criar_guia_desde_fatura_view, name='criar_guia_desde_fatura'), # <-- NOVA ROTA
    ...
    # --- URLs PARA GUIAS DE TRANSPORTE (ATUALIZADO) ---
    path('guias/', views.lista_guias_view, name='lista_guias'),
    path('guias/<int:guia_id>/', views.detalhe_guia_view, name='detalhe_guia'),
    path('guias/<int:guia_id>/editar/', views.editar_guia_view, name='editar_guia'), # <-- ROTA RESTAURADA
