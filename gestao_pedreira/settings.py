...
# A variável 'DEBUG' será 'True' se a variável de ambiente DEBUG não estiver definida (ambiente local)
# ou se estiver definida como 'true'. Em produção (PythonAnywhere), defina-a como 'False'.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'stock.context_processors.dados_empresa_processor',
            ],
        },
    },
]
